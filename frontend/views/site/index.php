                    ...
                    <ul>
                        <li>
                            <a href="">
                                ...
                                Browse through our pre-designed logos library and find what you need or use our keyword
                                search
                            </a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="">
                                <span class="glyphicon glyphicon-star" aria-hidden="true"></span>
                                Or get a scalable vector file (.eps) along with high quality previews in JPEG and PNG
                                only for 1.99$
                            </a>
                        </li>
                    </ul>
    ...
    <div class="container">
        <div class="">
            <div class="sample_cont clearfix">
                <div class="clearfix">
                    <div id="logotypes-btns" class="sample-btns col-sm-9">
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-6 col-sm-offset-3">
                ...
                <p class="text-center to_animate animated fadeInUp" data-animation="fadeInUp">Lorem ipsum dolor sit
                    amet, consectetur adipiscing elit. Maecenas ac augue at erat hendrerit dictum. Praesent porta, purus
                    eget sagittis imperdiet.</p>
            </div>
        </div>

        <div class="row" style="margin-top: 25px">
            <div class="col-sm-6 col-md-3 pricing-table to_animate animated fadeIn" data-animation="fadeIn"
                 style="opacity: 0;">
